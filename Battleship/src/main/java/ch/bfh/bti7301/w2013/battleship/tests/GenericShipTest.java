...
public class GenericShipTest {
	...
	public void testGenericShipCoordinatesCoordinatesIntSouth() {
		...
		Ship s = new AircraftCarrier(new Coordinates(3,2), new Coordinates(3,6));
	}
	...
	public void testGenericShipCoordinatesCoordinatesIntWest() {
		// This should not throw an exception
		Ship s = new Battleship(new Coordinates(106,103), new Coordinates(103,103));
	}
	...
	public void testGenericShipCoordinatesCoordinatesIntTooSmall() {
		...
		Ship s = new AircraftCarrier(new Coordinates(3,3), new Coordinates(2,3));
	}
	...
	public void testGetSize() {
		Ship s = new Destroyer(new Coordinates(3,3), Direction.NORTH);
